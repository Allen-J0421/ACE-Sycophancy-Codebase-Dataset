...
/**
 * Dependency-free test suite for {@link CircularDeque}.
 *
 ...
 * of a framework. Run with {@code java CircularDequeTest}; it prints a summary
 * and exits non-zero if any test fails.
 */
public final class CircularDequeTest {
    ...
    private static void constructorRejectsNonPositiveCapacity() {
        ...
        expectThrows(name, IllegalArgumentException.class, () -> new CircularDeque<>(0));
        expectThrows(name, IllegalArgumentException.class, () -> new CircularDeque<>(-3));
    }

    private static void newQueueIsEmpty() {
        String name = "newQueueIsEmpty";
        CircularDeque<Integer> q = new CircularDeque<>(4);
    ...
    private static void enqueueDequeuePreservesFifoOrder() {
        ...
        CircularDeque<Integer> q = new CircularDeque<>(3);
        q.enqueue(10);
        q.enqueue(20);
        q.enqueue(30);
    ...
    private static void equalsIgnoresInternalAlignment() {
        ...
        CircularDeque<Integer> aligned = new CircularDeque<>(3);
        aligned.enqueue(2);
        aligned.enqueue(3);

        CircularDeque<Integer> rotated = new CircularDeque<>(3);
        rotated.enqueue(9);
    ...
    private static void equalHashCodesForEqualQueues() {
        ...
        CircularDeque<Integer> a = new CircularDeque<>(4);
        a.enqueue(5);
        a.enqueue(6);
        CircularDeque<Integer> b = new CircularDeque<>(2);
        b.enqueue(5);
        b.enqueue(6);
    ...
    private static void toStringRendersFrontToRear() {
        ...
        CircularDeque<Integer> q = new CircularDeque<>(5);
        q.enqueue(10);
        q.enqueue(20);
        q.enqueue(30);
        checkEquals(name, "[10, 20, 30]", q.toString());
        checkEquals(name, "[]", new CircularDeque<Integer>(2).toString());
    }

    private static void nullElementsAreRejected() {
        String name = "nullElementsAreRejected";
        CircularDeque<String> q = new CircularDeque<>(2);
    ...
    private static void usableAsQueueInterface() {
        ...
        Queue<Integer> q = new CircularDeque<>(3); // referenced through the interface
    ...
    private static void offerReturnsFalseWhenFull() {
        ...
        CircularDeque<Integer> q = new CircularDeque<>(2);
    ...
    private static void usableAsDeque() {
        ...
        Deque<Integer> d = new CircularDeque<>(4); // referenced through the interface
        d.addFirst(2);
    ...
    private static void offerFirstLastReturnFalseWhenFull() {
        ...
        CircularDeque<Integer> d = new CircularDeque<>(2);
        d.offerFirst(1);
        d.offerLast(2);
    ...
    private static void usableAsStack() {
        ...
        Deque<Integer> stack = new CircularDeque<>(3);
        stack.push(1);
        stack.push(2);
        stack.push(3);
    ...
    private static void removeFirstOccurrenceRemovesFrontMost() {
        ...
        CircularDeque<Integer> d = new CircularDeque<>(6);
    ...
    private static void descendingIteratorGoesRearToFront() {
        ...
        CircularDeque<Integer> d = new CircularDeque<>(4);
    ...
    private static void iteratorRemoveDeletesCurrent() {
        ...
        CircularDeque<Integer> q = new CircularDeque<>(6);
    ...
    private static void bulkRemovalViaIterator() {
        ...
        CircularDeque<Integer> q = new CircularDeque<>(8);
