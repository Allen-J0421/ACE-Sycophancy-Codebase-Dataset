...
{
    // Constants shared by all harvester ants (class variables):
    //   The likelihood of a harvester ant breeding:
    private static final double BREEDING_PROBABILITY = 0.5;
    //   The maximum number of births:
    private static final int MAX_BIRTHS_AT_ONCE = 3;
    //   The worth of a harvester ant if consumed:
    private static final int CONSUMPTION_WORTH = 40;
    //   The age at which a harvester ant can start to breed:
    private static final int BREEDING_AGE = 1;
    //   The age to which a harvester ant can live:
    private static final int MAX_AGE = 200;
    //   Max sustenance level of the harvester ant:
    private static final int MAX_SUSTENANCE_LEVEL = 50;
    //   The prey this harvester ant hunts:
