 ...
 *
 * A scavenger animal present in the simulation. It shares the hunting
 * behaviour of {@link HungryAnimal} but feeds on carrion (dead prey) rather
 * than hunting live prey, and rests at sunset.
 *
 * @version 2022.03.02
 */
public abstract class Scavenger extends HungryAnimal {
    ...
    /**
     * Scavengers rest at sunset.
     *
     * @return The TimeOfDay during which the scavenger is inactive.
     */
    @Override
