...
public class SimulatorView extends JFrame
{
        ...
        for(int row = 0; row < field.getDepth(); row++) {
            for(int col = 0; col < field.getWidth(); col++) {
                ...
                if(thing!= null) {
                    ...
                    fieldView.markDisease(col, row, EMPTY_COLOR);
                }
    ...
    private class FieldView extends JPanel
    {
        ...
        /**
         * Paint over grid location with mark to indicate if an organism/water space is infected
         */
        public void markDisease(int x, int y, Color color)
        {
            g.setColor(color);
