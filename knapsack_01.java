...
record KnapsackInput(int capacity, List<Item> items) {
    KnapsackInput {
...
class KnapsackSolver {
    ...
    static int compute(int capacity, List<Item> items) {
...
class Knapsack {
    ...
    public static void main(String[] args) {
        KnapsackInput problem = new KnapsackInput(4, List.of(new Item(4, 1), new Item(5, 2), new Item(1, 3)));
