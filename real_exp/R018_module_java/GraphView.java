...
/**
 * The GraphView provides a view of seven populations of actors in the field as a line graph
 * over time.
 * 
...
public class GraphView implements SimulatorView
{
    ...
    // A map for storing colors for organisms in the simulation.
    ...
    class GraphPanel extends JComponent
    {
        ...
        private int lastVal1, lastVal2, lastVal3, lastVal4, lastVal5, lastVal6, lastVal7;
        private int yMax;
