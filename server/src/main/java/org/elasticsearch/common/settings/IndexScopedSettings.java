    ...
    public boolean isPrivateSetting(String key) {
        ...
        return switch (key) {
            case IndexMetadata.SETTING_CREATION_DATE,
                ...
                IndexMetadata.SETTING_HISTORY_UUID,
                IndexMetadata.SETTING_VERSION_UPGRADED,
                IndexMetadata.SETTING_INDEX_PROVIDED_NAME,
                MergePolicyConfig.INDEX_MERGE_ENABLED,
                "index.shrink.source.uuid",
                "index.shrink.source.name",
                IndexMetadata.INDEX_RESIZE_SOURCE_UUID_KEY,
                IndexMetadata.INDEX_RESIZE_SOURCE_NAME_KEY -> true;
