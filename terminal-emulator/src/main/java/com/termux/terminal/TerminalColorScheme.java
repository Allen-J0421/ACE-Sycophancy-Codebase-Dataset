...
public final class TerminalColorScheme {
    ...
    public void updateWith(Properties props) {
        ...
        for (Map.Entry<Object, Object> entries : props.entrySet()) {
            ...
            int colorIndex = colorIndexForKey(key);
            if (colorIndex == TextStyle.COLOR_INDEX_CURSOR) cursorPropExists = true;
    ...
    private static int colorIndexForKey(String key) {
        if (key.equals("foreground")) return TextStyle.COLOR_INDEX_FOREGROUND;
        if (key.equals("background")) return TextStyle.COLOR_INDEX_BACKGROUND;
        if (key.equals("cursor")) return TextStyle.COLOR_INDEX_CURSOR;
