...
/**
 * Correctness driver for 036_heap_sort.
 *
 * Baseline (iter 0): static HeapSort.heapSort(int[]) sorting in place.
 * Iterations 1-2: static HeapSort.sort(int[]).
 * Iterations 3-10: the int[] overload is gone; HeapSort exposes generic
 * static &lt;T extends Comparable&gt; sort(T[]) and sort(T[], Comparator) only,
 * so the driver also discovers the erased Comparable[]/Object[] signature and
 * exercises it with a boxed Integer[].
 *
...
public class Driver {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<Map.Entry<String, SortFn>> fns = discover(cs, "heap");
        if (fns.isEmpty()) {
